  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-sm">
          <form method="POST" action="{{ route('insertVidange') }}" enctype="multipart/form-data">
              <h1>Faire un vidange :</h1>
              @csrf
              <p>A combien de kilonmetre: <input type="number" name="km" class="border-gray-600 border-2"></p>
            <p>Date de vidange : <input type="date" name="dateV" class="border-gray-600 border-2"></p>
